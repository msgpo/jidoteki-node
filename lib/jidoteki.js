...
(function() {
  ...
  exports.getToken = function(callback) {
    var resource;
    resource = '/auth/user';
    return this.makeHMAC("POSThttps://" + settings.host + resource, function(signature) {
      return api.post({
        url: resource,
        headers: {
  ...
  exports.getData = function(resource, callback) {
    return this.makeHMAC("GEThttps://" + settings.host + resource, function(signature) {
      return api.get({
        url: resource,
        headers: {
  ...
  exports.postData = function(resource, string, callback) {
    return this.makeHMAC("POSThttps://" + settings.host + resource + (JSON.stringify(string)), function(signature) {
      return api.post({
        url: resource,
        params: string,
        headers: {
  ...
  exports.makeRequest = (function(_this) {
    return function() {
